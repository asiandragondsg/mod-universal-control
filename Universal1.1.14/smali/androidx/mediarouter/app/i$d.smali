.class Landroidx/mediarouter/app/i$d;
...
.method constructor <init>(Landroidx/mediarouter/app/i;)V
    ...
    iget-object v0, p1, Landroidx/mediarouter/app/i;->o1:Landroid/support/v4/media/MediaDescriptionCompat;
    ...
    :goto_0
    invoke-static {v0}, Landroidx/mediarouter/app/i;->h(Landroid/graphics/Bitmap;)Z
    ...
    iget-object p1, p1, Landroidx/mediarouter/app/i;->o1:Landroid/support/v4/media/MediaDescriptionCompat;
...
.method private e(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    iget-object v0, v0, Landroidx/mediarouter/app/i;->P0:Landroid/content/Context;
...
.method protected varargs a([Ljava/lang/Void;)Landroid/graphics/Bitmap;
    ...
    :try_start_0
    invoke-direct {p0, v0}, Landroidx/mediarouter/app/i$d;->e(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, v6}, Landroidx/mediarouter/app/i$d;->e(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    new-instance p1, Li/o/a/b$b;

    invoke-direct {p1, v0}, Li/o/a/b$b;-><init>(Landroid/graphics/Bitmap;)V

    invoke-virtual {p1, v2}, Li/o/a/b$b;->c(I)Li/o/a/b$b;

    invoke-virtual {p1}, Li/o/a/b$b;->a()Li/o/a/b;

    move-result-object p1

    invoke-virtual {p1}, Li/o/a/b;->f()Ljava/util/List;
...
.method protected d(Landroid/graphics/Bitmap;)V
    ...
    iput-object v1, v0, Landroidx/mediarouter/app/i;->p1:Landroidx/mediarouter/app/i$d;

    iget-object v0, v0, Landroidx/mediarouter/app/i;->q1:Landroid/graphics/Bitmap;

    iget-object v1, p0, Landroidx/mediarouter/app/i$d;->a:Landroid/graphics/Bitmap;

    invoke-static {v0, v1}, Li/h/n/c;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v0, v0, Landroidx/mediarouter/app/i;->r1:Landroid/net/Uri;
    ...
    iput-object v1, v0, Landroidx/mediarouter/app/i;->q1:Landroid/graphics/Bitmap;

    iput-object p1, v0, Landroidx/mediarouter/app/i;->t1:Landroid/graphics/Bitmap;

    iget-object p1, p0, Landroidx/mediarouter/app/i$d;->b:Landroid/net/Uri;

    iput-object p1, v0, Landroidx/mediarouter/app/i;->r1:Landroid/net/Uri;

    iget p1, p0, Landroidx/mediarouter/app/i$d;->c:I

    iput p1, v0, Landroidx/mediarouter/app/i;->u1:I

    const/4 p1, 0x1

    iput-boolean p1, v0, Landroidx/mediarouter/app/i;->s1:Z

    invoke-virtual {v0}, Landroidx/mediarouter/app/i;->t()V
...
.method protected onPreExecute()V
    ...
    invoke-virtual {v0}, Landroidx/mediarouter/app/i;->f()V
