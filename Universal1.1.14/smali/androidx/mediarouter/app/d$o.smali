...
.method public d(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    :goto_0
    iput-object p1, v0, Landroidx/mediarouter/app/d;->z1:Landroid/support/v4/media/MediaDescriptionCompat;

    iget-object p1, p0, Landroidx/mediarouter/app/d$o;->d:Landroidx/mediarouter/app/d;

    invoke-virtual {p1}, Landroidx/mediarouter/app/d;->I()V

    iget-object p1, p0, Landroidx/mediarouter/app/d$o;->d:Landroidx/mediarouter/app/d;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroidx/mediarouter/app/d;->H(Z)V
...
.method public e(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    iput-object p1, v0, Landroidx/mediarouter/app/d;->y1:Landroid/support/v4/media/session/PlaybackStateCompat;

    const/4 p1, 0x0

    invoke-virtual {v0, p1}, Landroidx/mediarouter/app/d;->H(Z)V
...
.method public i()V
    ...
    iget-object v1, v0, Landroidx/mediarouter/app/d;->w1:Landroid/support/v4/media/session/MediaControllerCompat;

    if-eqz v1, :cond_0

    iget-object v0, v0, Landroidx/mediarouter/app/d;->x1:Landroidx/mediarouter/app/d$o;
    ...
    iput-object v1, v0, Landroidx/mediarouter/app/d;->w1:Landroid/support/v4/media/session/MediaControllerCompat;
