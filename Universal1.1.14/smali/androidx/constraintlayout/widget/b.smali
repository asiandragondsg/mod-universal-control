...
.method public static b(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;Ljava/util/HashMap;)V
    ...
    sget-object v0, Landroidx/constraintlayout/widget/k;->k2:[I
    ...
    sget v7, Landroidx/constraintlayout/widget/k;->l2:I
    ...
    :cond_0
    sget v7, Landroidx/constraintlayout/widget/k;->m2:I
    ...
    sget-object v4, Landroidx/constraintlayout/widget/b$b;->K0:Landroidx/constraintlayout/widget/b$b;

    goto/16 :goto_5

    :cond_1
    sget v7, Landroidx/constraintlayout/widget/k;->o2:I

    if-ne v6, v7, :cond_2

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->H0:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_2
    sget v7, Landroidx/constraintlayout/widget/k;->n2:I

    if-ne v6, v7, :cond_3

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->I0:Landroidx/constraintlayout/widget/b$b;

    goto :goto_1

    :cond_3
    sget v7, Landroidx/constraintlayout/widget/k;->s2:I

    const/4 v9, 0x0

    if-ne v6, v7, :cond_4

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->L0:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_4
    sget v7, Landroidx/constraintlayout/widget/k;->p2:I
    ...
    :cond_5
    sget v7, Landroidx/constraintlayout/widget/k;->q2:I

    if-ne v6, v7, :cond_6

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->G0:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_6
    sget v7, Landroidx/constraintlayout/widget/k;->r2:I

    if-ne v6, v7, :cond_7

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->F0:Landroidx/constraintlayout/widget/b$b;
    ...
    :cond_7
    sget v7, Landroidx/constraintlayout/widget/k;->t2:I

    if-ne v6, v7, :cond_8

    sget-object v3, Landroidx/constraintlayout/widget/b$b;->J0:Landroidx/constraintlayout/widget/b$b;
