...
.field private V0:Landroidx/appcompat/widget/k0;
...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    iput v0, p0, Landroidx/appcompat/widget/l0$a;->T0:I

    iput v1, p0, Landroidx/appcompat/widget/l0$a;->U0:I

    goto :goto_0

    :cond_0
    iput v1, p0, Landroidx/appcompat/widget/l0$a;->T0:I

    iput v0, p0, Landroidx/appcompat/widget/l0$a;->U0:I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/l0$a;->V0:Landroidx/appcompat/widget/k0;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/l0$a;->W0:Landroid/view/MenuItem;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/l0$a;->V0:Landroidx/appcompat/widget/k0;

    invoke-interface {v3, v0, v1}, Landroidx/appcompat/widget/k0;->g(Landroidx/appcompat/view/menu/g;Landroid/view/MenuItem;)V

    :cond_2
    iput-object v2, p0, Landroidx/appcompat/widget/l0$a;->W0:Landroid/view/MenuItem;

    if-eqz v2, :cond_3

    iget-object v1, p0, Landroidx/appcompat/widget/l0$a;->V0:Landroidx/appcompat/widget/k0;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroidx/appcompat/widget/l0$a;->T0:I
    ...
    iget v0, p0, Landroidx/appcompat/widget/l0$a;->U0:I
...
.method public setHoverListener(Landroidx/appcompat/widget/k0;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/l0$a;->V0:Landroidx/appcompat/widget/k0;
