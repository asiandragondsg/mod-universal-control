...
# instance fields
.field private F0:Landroidx/appcompat/widget/ActionMenuView;

.field private G0:Landroid/widget/TextView;

.field private H0:Landroid/widget/TextView;

.field private I0:Landroid/widget/ImageButton;
...
.field M0:Landroid/widget/ImageButton;
...
.field private Y0:Landroidx/appcompat/widget/o0;
...
.field l1:Landroidx/appcompat/widget/Toolbar$f;

.field private final m1:Landroidx/appcompat/widget/ActionMenuView$e;

.field private n1:Landroidx/appcompat/widget/x0;

.field private o1:Landroidx/appcompat/widget/c;

.field private p1:Landroidx/appcompat/widget/Toolbar$d;

.field private q1:Landroidx/appcompat/view/menu/m$a;

.field private r1:Landroidx/appcompat/view/menu/g$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Landroidx/appcompat/widget/Toolbar;->b1:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->i1:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->j1:Ljava/util/ArrayList;

    const/4 v0, 0x2

    new-array v0, v0, [I

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->k1:[I

    new-instance v0, Landroidx/appcompat/widget/Toolbar$a;

    invoke-direct {v0, p0}, Landroidx/appcompat/widget/Toolbar$a;-><init>(Landroidx/appcompat/widget/Toolbar;)V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->m1:Landroidx/appcompat/widget/ActionMenuView$e;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->t1:Ljava/lang/Runnable;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v3, Li/a/j;->H2:[I

    const/4 v8, 0x0

    invoke-static {v0, p2, v3, p3, v8}, Landroidx/appcompat/widget/w0;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/appcompat/widget/w0;
    ...
    invoke-static/range {v1 .. v7}, Li/h/o/t;->f0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    iget p2, p0, Landroidx/appcompat/widget/Toolbar;->b1:I

    invoke-virtual {v0, p1, p2}, Landroidx/appcompat/widget/w0;->l(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/Toolbar;->b1:I
    ...
    invoke-virtual {v0, p1, v8}, Landroidx/appcompat/widget/w0;->e(II)I
    ...
    invoke-virtual {v0, v1, v8}, Landroidx/appcompat/widget/w0;->f(II)I

    move-result v1

    sget v2, Li/a/j;->P2:I

    invoke-virtual {v0, v2, v8}, Landroidx/appcompat/widget/w0;->f(II)I

    move-result v2

    invoke-direct {p0}, Landroidx/appcompat/widget/Toolbar;->h()V

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar;->Y0:Landroidx/appcompat/widget/o0;
    ...
    :cond_5
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->Y0:Landroidx/appcompat/widget/o0;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->O0:Landroid/content/Context;
...
.method private F()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->t1:Ljava/lang/Runnable;
...
.method private L()Z
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/Toolbar;->s1:Z
...
.method private b(Ljava/util/List;I)V
    ...
    invoke-static {p2, v4}, Li/h/o/d;->b(II)I
...
.method private c(Landroid/view/View;Z)V
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/Toolbar;->N0:Landroid/view/View;

    if-eqz p2, :cond_2

    invoke-virtual {p1, v0}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object p2, p0, Landroidx/appcompat/widget/Toolbar;->j1:Ljava/util/ArrayList;
...
.method private h()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->Y0:Landroidx/appcompat/widget/o0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->Y0:Landroidx/appcompat/widget/o0;
...
.method private i()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->J0:Landroid/widget/ImageView;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->J0:Landroid/widget/ImageView;
...
.method private j()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;

    :cond_0
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->O0:Landroid/content/Context;
...
.method private k()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->m1:Landroidx/appcompat/widget/ActionMenuView$e;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/ActionMenuView;->setOnMenuItemClickListener(Landroidx/appcompat/widget/ActionMenuView$e;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->q1:Landroidx/appcompat/view/menu/m$a;

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->r1:Landroidx/appcompat/view/menu/g$a;
...
.method private l()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;
...
.method private p(I)I
    ...
    invoke-static {p1, v0}, Li/h/o/d;->b(II)I
...
.method private r(I)I
    ...
    iget p1, p0, Landroidx/appcompat/widget/Toolbar;->b1:I
...
.method private s(Landroid/view/View;)I
    ...
    invoke-static {p1}, Li/h/o/g;->b(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method private y(Landroid/view/View;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->j1:Ljava/util/ArrayList;
...
.method G()V
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;

    if-eq v1, v2, :cond_0

    invoke-virtual {p0, v0}, Landroid/view/ViewGroup;->removeViewAt(I)V

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->j1:Ljava/util/ArrayList;
...
.method public I(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/widget/c;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->o1:Landroidx/appcompat/widget/c;
    ...
    :cond_2
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->O0:Landroid/content/Context;

    invoke-virtual {p1, p2, v0}, Landroidx/appcompat/view/menu/g;->c(Landroidx/appcompat/view/menu/m;Landroid/content/Context;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->O0:Landroid/content/Context;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->O0:Landroid/content/Context;

    const/4 v1, 0x0

    invoke-virtual {p2, p1, v1}, Landroidx/appcompat/widget/c;->h(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;
    ...
    :goto_0
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar;->o1:Landroidx/appcompat/widget/c;
...
.method public J(Landroid/content/Context;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
...
.method public K(Landroid/content/Context;I)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
...
.method a()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->j1:Ljava/util/ArrayList;
...
.method public e()V
    ...
    :cond_0
    iget-object v0, v0, Landroidx/appcompat/widget/Toolbar$d;->G0:Landroidx/appcompat/view/menu/i;
...
.method g()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->K0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v1}, Landroid/widget/ImageButton;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->M0:Landroid/widget/ImageButton;

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->L0:Ljava/lang/CharSequence;
...
.method public getCurrentContentInsetEnd()I
    ...
    iget v2, p0, Landroidx/appcompat/widget/Toolbar;->a1:I
...
.method getOuterActionMenuPresenter()Landroidx/appcompat/widget/c;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->o1:Landroidx/appcompat/widget/c;
...
.method public getSubtitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->d1:Ljava/lang/CharSequence;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->c1:Ljava/lang/CharSequence;
...
.method public getWrapper()Landroidx/appcompat/widget/d0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->n1:Landroidx/appcompat/widget/x0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->n1:Landroidx/appcompat/widget/x0;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v1, p0, Landroidx/appcompat/widget/Toolbar;->h1:Z

    :cond_0
    iget-boolean v3, p0, Landroidx/appcompat/widget/Toolbar;->h1:Z
    ...
    iput-boolean v4, p0, Landroidx/appcompat/widget/Toolbar;->h1:Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-static/range {p0 .. p0}, Li/h/o/t;->y(Landroid/view/View;)I
    ...
    iget-object v11, v0, Landroidx/appcompat/widget/Toolbar;->k1:[I

    aput v3, v11, v2

    aput v3, v11, v3

    invoke-static/range {p0 .. p0}, Li/h/o/t;->z(Landroid/view/View;)I
    ...
    :goto_1
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;
    ...
    :goto_3
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->M0:Landroid/widget/ImageButton;
    ...
    :cond_5
    :goto_4
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->N0:Landroid/view/View;
    ...
    :cond_9
    :goto_6
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->J0:Landroid/widget/ImageView;
    ...
    :cond_b
    :goto_7
    iget-object v13, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;

    invoke-direct {v0, v13}, Landroidx/appcompat/widget/Toolbar;->M(Landroid/view/View;)Z

    move-result v13

    iget-object v14, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v7, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v7, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v15, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    :goto_e
    iget v15, v0, Landroidx/appcompat/widget/Toolbar;->b1:I
    ...
    iget v12, v0, Landroidx/appcompat/widget/Toolbar;->W0:I
    ...
    iget v3, v0, Landroidx/appcompat/widget/Toolbar;->X0:I
    ...
    iget v3, v0, Landroidx/appcompat/widget/Toolbar;->W0:I
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget v7, v0, Landroidx/appcompat/widget/Toolbar;->U0:I
    ...
    iget-object v5, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v6, v0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;

    invoke-virtual {v6, v2, v8, v4, v5}, Landroid/widget/TextView;->layout(IIII)V

    iget v6, v0, Landroidx/appcompat/widget/Toolbar;->V0:I
    ...
    iget-object v6, v0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    :cond_21
    :goto_17
    iget-object v3, v0, Landroidx/appcompat/widget/Toolbar;->i1:Ljava/util/ArrayList;
    ...
    iget-object v4, v0, Landroidx/appcompat/widget/Toolbar;->i1:Ljava/util/ArrayList;
    ...
    :cond_26
    iget-object v1, v0, Landroidx/appcompat/widget/Toolbar;->i1:Ljava/util/ArrayList;
...
.method protected onMeasure(II)V
    ...
    iget-object v8, v7, Landroidx/appcompat/widget/Toolbar;->k1:[I
    ...
    :goto_0
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;

    const/4 v5, 0x0

    iget v6, v7, Landroidx/appcompat/widget/Toolbar;->T0:I
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->I0:Landroid/widget/ImageButton;
    ...
    :goto_1
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->M0:Landroid/widget/ImageButton;
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->M0:Landroid/widget/ImageButton;
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->M0:Landroid/widget/ImageButton;
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->F0:Landroidx/appcompat/widget/ActionMenuView;
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->N0:Landroid/view/View;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->N0:Landroid/view/View;
    ...
    :cond_4
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->J0:Landroid/widget/ImageView;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->J0:Landroid/widget/ImageView;
    ...
    :cond_8
    iget v0, v7, Landroidx/appcompat/widget/Toolbar;->W0:I

    iget v1, v7, Landroidx/appcompat/widget/Toolbar;->X0:I
    ...
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    :goto_5
    iget-object v0, v7, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v1, v7, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    :goto_0
    iget v1, p1, Landroidx/appcompat/widget/Toolbar$g;->H0:I

    if-eqz v1, :cond_2

    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->p1:Landroidx/appcompat/widget/Toolbar$d;
    ...
    :cond_2
    iget-boolean p1, p1, Landroidx/appcompat/widget/Toolbar$g;->I0:Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/Toolbar$d;->G0:Landroidx/appcompat/view/menu/i;
    ...
    iput v1, v0, Landroidx/appcompat/widget/Toolbar$g;->H0:I
    ...
    iput-boolean v1, v0, Landroidx/appcompat/widget/Toolbar$g;->I0:Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iput-boolean v1, p0, Landroidx/appcompat/widget/Toolbar;->g1:Z

    :cond_0
    iget-boolean v2, p0, Landroidx/appcompat/widget/Toolbar;->g1:Z
    ...
    iput-boolean v3, p0, Landroidx/appcompat/widget/Toolbar;->g1:Z
...
.method public setCollapseIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar;->M0:Landroid/widget/ImageButton;

    if-eqz p1, :cond_1

    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->K0:Landroid/graphics/drawable/Drawable;
...
.method public setCollapsible(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/Toolbar;->s1:Z
...
.method public setLogo(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->J0:Landroid/widget/ImageView;
...
.method public setOnMenuItemClickListener(Landroidx/appcompat/widget/Toolbar$f;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->l1:Landroidx/appcompat/widget/Toolbar$f;
...
.method public setPopupTheme(I)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar;->O0:Landroid/content/Context;
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;

    invoke-virtual {v1}, Landroid/widget/TextView;->setSingleLine()V

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->H0:Landroid/widget/TextView;

    invoke-virtual {v2, v0, v1}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->f1:Landroid/content/res/ColorStateList;
...
.method public setSubtitleTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->f1:Landroid/content/res/ColorStateList;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;

    invoke-virtual {v1}, Landroid/widget/TextView;->setSingleLine()V

    iget-object v1, p0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar;->G0:Landroid/widget/TextView;

    invoke-virtual {v2, v0, v1}, Landroid/widget/TextView;->setTextAppearance(Landroid/content/Context;I)V

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar;->e1:Landroid/content/res/ColorStateList;
    ...
    :cond_4
    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->c1:Ljava/lang/CharSequence;
...
.method public setTitleTextColor(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/Toolbar;->e1:Landroid/content/res/ColorStateList;
