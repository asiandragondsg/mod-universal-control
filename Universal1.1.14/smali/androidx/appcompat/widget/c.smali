...
# instance fields
.field N0:Landroidx/appcompat/widget/c$d;
...
.field private final a1:Landroid/util/SparseBooleanArray;

.field b1:Landroidx/appcompat/widget/c$e;

.field c1:Landroidx/appcompat/widget/c$a;

.field d1:Landroidx/appcompat/widget/c$c;

.field private e1:Landroidx/appcompat/widget/c$b;

.field final f1:Landroidx/appcompat/widget/c$f;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->a1:Landroid/util/SparseBooleanArray;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->f1:Landroidx/appcompat/widget/c$f;
...
.method static synthetic r(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/g;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/b;->H0:Landroidx/appcompat/view/menu/g;
...
.method static synthetic t(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/n;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;
...
.method private z(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;
...
.method public A()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;
    ...
    :cond_0
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->P0:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroidx/appcompat/widget/c;->O0:Landroid/graphics/drawable/Drawable;
...
.method public B()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->d1:Landroidx/appcompat/widget/c$c;

    const/4 v1, 0x1

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/c;->d1:Landroidx/appcompat/widget/c$c;

    return v1

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/c;->b1:Landroidx/appcompat/widget/c$e;
...
.method public C()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->c1:Landroidx/appcompat/widget/c$a;
...
.method public F(Landroid/content/res/Configuration;)V
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/c;->V0:Z

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->G0:Landroid/content/Context;

    invoke-static {p1}, Li/a/n/a;->b(Landroid/content/Context;)Li/a/n/a;

    move-result-object p1

    invoke-virtual {p1}, Li/a/n/a;->d()I

    move-result p1

    iput p1, p0, Landroidx/appcompat/widget/c;->U0:I

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->H0:Landroidx/appcompat/view/menu/g;
...
.method public G(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/c;->Y0:Z
...
.method public H(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->H0:Landroidx/appcompat/view/menu/g;
...
.method public I(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/widget/c;->P0:Z

    iput-object p1, p0, Landroidx/appcompat/widget/c;->O0:Landroid/graphics/drawable/Drawable;
...
.method public J(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/widget/c;->Q0:Z

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroidx/appcompat/widget/c;->R0:Z
...
.method public K()Z
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->Q0:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroidx/appcompat/widget/c;->d1:Landroidx/appcompat/widget/c$c;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->G0:Landroid/content/Context;

    iget-object v4, p0, Landroidx/appcompat/view/menu/b;->H0:Landroidx/appcompat/view/menu/g;

    iget-object v5, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/c;->d1:Landroidx/appcompat/widget/c$c;
...
.method public c(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/i;->b()Li/h/o/b;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, Li/h/o/b;->k(Li/h/o/b$a;)V
    ...
    :goto_1
    iget-boolean v1, p0, Landroidx/appcompat/widget/c;->Q0:Z
    ...
    :cond_4
    :goto_2
    iget-object p1, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;
...
.method public d()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b;->H0:Landroidx/appcompat/view/menu/g;
    ...
    :goto_0
    iget v5, v0, Landroidx/appcompat/widget/c;->U0:I

    iget v6, v0, Landroidx/appcompat/widget/c;->T0:I

    invoke-static {v3, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v7

    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->M0:Landroidx/appcompat/view/menu/n;
    ...
    :goto_2
    iget-boolean v13, v0, Landroidx/appcompat/widget/c;->Y0:Z
    ...
    :cond_4
    iget-boolean v9, v0, Landroidx/appcompat/widget/c;->Q0:Z
    ...
    iget-object v9, v0, Landroidx/appcompat/widget/c;->a1:Landroid/util/SparseBooleanArray;

    invoke-virtual {v9}, Landroid/util/SparseBooleanArray;->clear()V

    iget-boolean v10, v0, Landroidx/appcompat/widget/c;->W0:Z

    if-eqz v10, :cond_7

    iget v10, v0, Landroidx/appcompat/widget/c;->Z0:I
    ...
    iget-boolean v2, v0, Landroidx/appcompat/widget/c;->W0:Z
    ...
    iget-boolean v3, v0, Landroidx/appcompat/widget/c;->W0:Z
    ...
    :cond_11
    iget-boolean v4, v0, Landroidx/appcompat/widget/c;->W0:Z
...
.method public h(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->R0:Z

    if-nez v0, :cond_0

    invoke-virtual {p1}, Li/a/n/a;->h()Z

    move-result v0

    iput-boolean v0, p0, Landroidx/appcompat/widget/c;->Q0:Z

    :cond_0
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->X0:Z

    if-nez v0, :cond_1

    invoke-virtual {p1}, Li/a/n/a;->c()I

    move-result v0

    iput v0, p0, Landroidx/appcompat/widget/c;->S0:I

    :cond_1
    iget-boolean v0, p0, Landroidx/appcompat/widget/c;->V0:Z
    ...
    :cond_2
    iget p1, p0, Landroidx/appcompat/widget/c;->S0:I
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/b;->F0:Landroid/content/Context;

    invoke-direct {v0, p0, v2}, Landroidx/appcompat/widget/c$d;-><init>(Landroidx/appcompat/widget/c;Landroid/content/Context;)V

    iput-object v0, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;

    iget-boolean v2, p0, Landroidx/appcompat/widget/c;->P0:Z

    const/4 v3, 0x0

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroidx/appcompat/widget/c;->O0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/o;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Landroidx/appcompat/widget/c;->O0:Landroid/graphics/drawable/Drawable;

    iput-boolean v3, p0, Landroidx/appcompat/widget/c;->P0:Z
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;
    ...
    :cond_5
    iput-object v1, p0, Landroidx/appcompat/widget/c;->N0:Landroidx/appcompat/widget/c$d;

    :goto_0
    iput p1, p0, Landroidx/appcompat/widget/c;->T0:I
    ...
    iput p1, p0, Landroidx/appcompat/widget/c;->Z0:I
...
.method public i(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/n$a;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/c;->e1:Landroidx/appcompat/widget/c$b;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->e1:Landroidx/appcompat/widget/c$b;
...
.method public j(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->H0:Landroidx/appcompat/view/menu/g;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/c;->c1:Landroidx/appcompat/widget/c$a;
