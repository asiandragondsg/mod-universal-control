...
.field o1:Landroid/widget/ListAdapter;

.field private final p1:Landroid/graphics/Rect;

.field private q1:I

.field final synthetic r1:Landroidx/appcompat/widget/w;
...
.method public constructor <init>(Landroidx/appcompat/widget/w;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/w$e;->p1:Landroid/graphics/Rect;
...
.method R()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/j0;->h()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;

    iget-object v1, v1, Landroidx/appcompat/widget/w;->M0:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/w;->M0:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;

    invoke-virtual {v2}, Landroid/widget/Spinner;->getPaddingRight()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;

    invoke-virtual {v3}, Landroid/widget/Spinner;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;

    iget v5, v4, Landroidx/appcompat/widget/w;->L0:I

    const/4 v6, -0x2

    if-ne v5, v6, :cond_3

    iget-object v5, p0, Landroidx/appcompat/widget/w$e;->o1:Landroid/widget/ListAdapter;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;

    iget-object v6, v6, Landroidx/appcompat/widget/w;->M0:Landroid/graphics/Rect;
...
.method public S()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/w$e;->q1:I
...
.method T(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Li/h/o/t;->M(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->p1:Landroid/graphics/Rect;
...
.method public f()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->n1:Ljava/lang/CharSequence;
...
.method public j(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->n1:Ljava/lang/CharSequence;
...
.method public l(I)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/w$e;->q1:I
...
.method public m(II)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/j0;->i()Landroid/widget/ListView;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/w$e;->r1:Landroidx/appcompat/widget/w;
...
.method public o(Landroid/widget/ListAdapter;)V
    ...
    invoke-super {p0, p1}, Landroidx/appcompat/widget/j0;->o(Landroid/widget/ListAdapter;)V

    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->o1:Landroid/widget/ListAdapter;
