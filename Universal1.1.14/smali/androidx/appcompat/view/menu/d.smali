...
.field final L0:Landroid/os/Handler;
...
.field private final Q0:Landroidx/appcompat/widget/k0;
...
.field private c1:Landroidx/appcompat/view/menu/m$a;

.field d1:Landroid/view/ViewTreeObserver;

.field private e1:Landroid/widget/PopupWindow$OnDismissListener;
...
.method static constructor <clinit>()V
    ...
    sput v0, Landroidx/appcompat/view/menu/d;->g1:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->M0:Ljava/util/List;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->N0:Ljava/util/List;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->O0:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->P0:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->Q0:Landroidx/appcompat/widget/k0;

    const/4 v0, 0x0

    iput v0, p0, Landroidx/appcompat/view/menu/d;->R0:I

    iput v0, p0, Landroidx/appcompat/view/menu/d;->S0:I

    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->G0:Landroid/content/Context;

    iput-object p2, p0, Landroidx/appcompat/view/menu/d;->T0:Landroid/view/View;

    iput p3, p0, Landroidx/appcompat/view/menu/d;->I0:I

    iput p4, p0, Landroidx/appcompat/view/menu/d;->J0:I

    iput-boolean p5, p0, Landroidx/appcompat/view/menu/d;->K0:Z

    iput-boolean v0, p0, Landroidx/appcompat/view/menu/d;->a1:Z

    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->C()I

    move-result p2

    iput p2, p0, Landroidx/appcompat/view/menu/d;->V0:I
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/d;->H0:I

    new-instance p1, Landroid/os/Handler;

    invoke-direct {p1}, Landroid/os/Handler;-><init>()V

    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->L0:Landroid/os/Handler;
...
.method private C()I
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->T0:Landroid/view/View;

    invoke-static {v0}, Li/h/o/t;->y(Landroid/view/View;)I
...
.method private D(I)I
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->N0:Ljava/util/List;
    ...
    iget-object v4, p0, Landroidx/appcompat/view/menu/d;->U0:Landroid/view/View;

    invoke-virtual {v4, v3}, Landroid/view/View;->getWindowVisibleDisplayFrame(Landroid/graphics/Rect;)V

    iget v4, p0, Landroidx/appcompat/view/menu/d;->V0:I
...
.method private E(Landroidx/appcompat/view/menu/g;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->G0:Landroid/content/Context;
    ...
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/d;->K0:Z

    sget v3, Landroidx/appcompat/view/menu/d;->g1:I
    ...
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/d;->a1:Z
    ...
    :cond_1
    :goto_0
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->G0:Landroid/content/Context;

    iget v4, p0, Landroidx/appcompat/view/menu/d;->H0:I
    ...
    invoke-direct {p0}, Landroidx/appcompat/view/menu/d;->y()Landroidx/appcompat/widget/l0;

    move-result-object v4

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/j0;->o(Landroid/widget/ListAdapter;)V

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/j0;->E(I)V

    iget v1, p0, Landroidx/appcompat/view/menu/d;->S0:I

    invoke-virtual {v4, v1}, Landroidx/appcompat/widget/j0;->F(I)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->N0:Ljava/util/List;
    ...
    :goto_2
    iput v8, p0, Landroidx/appcompat/view/menu/d;->V0:I
    ...
    iget-object v12, p0, Landroidx/appcompat/view/menu/d;->T0:Landroid/view/View;
    ...
    iget v12, p0, Landroidx/appcompat/view/menu/d;->S0:I
    ...
    iget-object v13, p0, Landroidx/appcompat/view/menu/d;->T0:Landroid/view/View;
    ...
    :goto_3
    iget v10, p0, Landroidx/appcompat/view/menu/d;->S0:I
    ...
    :goto_6
    invoke-virtual {v4, v12}, Landroidx/appcompat/widget/j0;->e(I)V

    invoke-virtual {v4, v3}, Landroidx/appcompat/widget/j0;->L(Z)V

    invoke-virtual {v4, v8}, Landroidx/appcompat/widget/j0;->k(I)V

    goto :goto_7

    :cond_9
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/d;->W0:Z

    if-eqz v2, :cond_a

    iget v2, p0, Landroidx/appcompat/view/menu/d;->Y0:I

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/j0;->e(I)V

    :cond_a
    iget-boolean v2, p0, Landroidx/appcompat/view/menu/d;->X0:Z

    if-eqz v2, :cond_b

    iget v2, p0, Landroidx/appcompat/view/menu/d;->Z0:I

    invoke-virtual {v4, v2}, Landroidx/appcompat/widget/j0;->k(I)V
    ...
    iget v3, p0, Landroidx/appcompat/view/menu/d;->V0:I
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/d;->N0:Ljava/util/List;

    invoke-interface {v3, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v4}, Landroidx/appcompat/widget/j0;->show()V

    invoke-virtual {v4}, Landroidx/appcompat/widget/j0;->i()Landroid/widget/ListView;
    ...
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/d;->b1:Z
...
.method private y()Landroidx/appcompat/widget/l0;
    .locals 5

    new-instance v0, Landroidx/appcompat/widget/l0;

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->G0:Landroid/content/Context;

    iget v2, p0, Landroidx/appcompat/view/menu/d;->I0:I

    iget v3, p0, Landroidx/appcompat/view/menu/d;->J0:I

    const/4 v4, 0x0

    invoke-direct {v0, v1, v4, v2, v3}, Landroidx/appcompat/widget/l0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->Q0:Landroidx/appcompat/widget/k0;

    invoke-virtual {v0, v1}, Landroidx/appcompat/widget/l0;->S(Landroidx/appcompat/widget/k0;)V
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->T0:Landroid/view/View;
...
.method private z(Landroidx/appcompat/view/menu/g;)I
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/d;->N0:Ljava/util/List;
...
.method public b(Landroidx/appcompat/view/menu/g;Z)V
    ...
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/d;->f1:Z
    ...
    :goto_0
    iput v1, p0, Landroidx/appcompat/view/menu/d;->V0:I

    if-nez v0, :cond_7

    invoke-virtual {p0}, Landroidx/appcompat/view/menu/d;->dismiss()V

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->c1:Landroidx/appcompat/view/menu/m$a;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->d1:Landroid/view/ViewTreeObserver;
    ...
    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->O0:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {p1, p2}, Landroid/view/ViewTreeObserver;->removeGlobalOnLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_5
    iput-object v2, p0, Landroidx/appcompat/view/menu/d;->d1:Landroid/view/ViewTreeObserver;

    :cond_6
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->U0:Landroid/view/View;

    iget-object p2, p0, Landroidx/appcompat/view/menu/d;->P0:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {p1, p2}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->e1:Landroid/widget/PopupWindow$OnDismissListener;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/d;->N0:Ljava/util/List;
...
.method public dismiss()V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/widget/j0;->a()Z
...
.method public g(Landroidx/appcompat/view/menu/m$a;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->c1:Landroidx/appcompat/view/menu/m$a;
...
.method public j(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->c1:Landroidx/appcompat/view/menu/m$a;
...
.method public k(Landroidx/appcompat/view/menu/g;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->M0:Ljava/util/List;
...
.method public o(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->T0:Landroid/view/View;

    iget v0, p0, Landroidx/appcompat/view/menu/d;->R0:I

    invoke-static {p1}, Li/h/o/t;->y(Landroid/view/View;)I

    move-result p1

    invoke-static {v0, p1}, Li/h/o/d;->b(II)I

    move-result p1

    iput p1, p0, Landroidx/appcompat/view/menu/d;->S0:I
...
.method public q(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/d;->a1:Z
...
.method public r(I)V
    ...
    iput p1, p0, Landroidx/appcompat/view/menu/d;->R0:I
...
.method public s(I)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/d;->W0:Z

    iput p1, p0, Landroidx/appcompat/view/menu/d;->Y0:I
...
.method public show()V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->U0:Landroid/view/View;

    if-eqz v0, :cond_4

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->d1:Landroid/view/ViewTreeObserver;
    ...
    iput-object v0, p0, Landroidx/appcompat/view/menu/d;->d1:Landroid/view/ViewTreeObserver;

    if-eqz v1, :cond_3

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->O0:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    :cond_3
    iget-object v0, p0, Landroidx/appcompat/view/menu/d;->U0:Landroid/view/View;

    iget-object v1, p0, Landroidx/appcompat/view/menu/d;->P0:Landroid/view/View$OnAttachStateChangeListener;
...
.method public t(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/d;->e1:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public u(Z)V
    ...
    iput-boolean p1, p0, Landroidx/appcompat/view/menu/d;->b1:Z
...
.method public v(I)V
    ...
    iput-boolean v0, p0, Landroidx/appcompat/view/menu/d;->X0:Z

    iput p1, p0, Landroidx/appcompat/view/menu/d;->Z0:I
