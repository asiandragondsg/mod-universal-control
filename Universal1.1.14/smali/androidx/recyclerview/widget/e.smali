...
# static fields
.field static final J0:Ljava/lang/ThreadLocal;
...
.field static K0:Ljava/util/Comparator;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/e;->J0:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/e$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/e$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/e;->K0:Ljava/util/Comparator;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/e;->F0:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Landroidx/recyclerview/widget/e;->I0:Ljava/util/ArrayList;
...
.method private b()V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/e;->F0:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroidx/recyclerview/widget/e;->F0:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->H1:Landroidx/recyclerview/widget/e$b;
    ...
    :cond_1
    iget-object v2, p0, Landroidx/recyclerview/widget/e;->I0:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/e;->I0:Ljava/util/ArrayList;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/e;->I0:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v0, p0, Landroidx/recyclerview/widget/e;->I0:Ljava/util/ArrayList;

    sget-object v1, Landroidx/recyclerview/widget/e;->K0:Ljava/util/Comparator;
...
.method private d(J)V
    ...
    :goto_0
    iget-object v1, p0, Landroidx/recyclerview/widget/e;->I0:Ljava/util/ArrayList;
...
.method private h(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    :cond_1
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->H1:Landroidx/recyclerview/widget/e$b;
    ...
    iget-object v2, p1, Landroidx/recyclerview/widget/RecyclerView;->P0:Landroidx/recyclerview/widget/RecyclerView$f;
...
.method private i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$c0;
    ...
    :cond_0
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->G0:Landroidx/recyclerview/widget/RecyclerView$u;
...
.method f(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-wide v0, p0, Landroidx/recyclerview/widget/e;->G0:J
    ...
    iput-wide v0, p0, Landroidx/recyclerview/widget/e;->G0:J

    invoke-virtual {p1, p0}, Landroid/view/ViewGroup;->post(Ljava/lang/Runnable;)Z

    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->H1:Landroidx/recyclerview/widget/e$b;
...
.method public run()V
    ...
    invoke-static {v2}, Li/h/k/a;->a(Ljava/lang/String;)V

    iget-object v2, p0, Landroidx/recyclerview/widget/e;->F0:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/e;->F0:Ljava/util/ArrayList;
    ...
    iget-wide v4, p0, Landroidx/recyclerview/widget/e;->H0:J
