.class public Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;
...
.method public constructor <init>(Ljava/net/InetAddress;)V
    ...
    invoke-direct {p0, p1, v0, v1}, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;-><init>(Ljava/net/InetAddress;Ljava/net/MulticastSocket;Ljava/net/DatagramSocket;)V
...
.method public constructor <init>(Ljava/net/InetAddress;Ljava/net/MulticastSocket;Ljava/net/DatagramSocket;)V
    ...
    iput v0, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->timeout:I

    iput-object p1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->localInAddress:Ljava/net/InetAddress;

    iput-object p2, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastSocket:Ljava/net/MulticastSocket;

    iput-object p3, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->datagramSocket:Ljava/net/DatagramSocket;
    ...
    iput-object p1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastGroup:Ljava/net/SocketAddress;

    iget-object p1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->localInAddress:Ljava/net/InetAddress;

    invoke-static {p1}, Ljava/net/NetworkInterface;->getByInetAddress(Ljava/net/InetAddress;)Ljava/net/NetworkInterface;

    move-result-object p1

    iput-object p1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->networkInterface:Ljava/net/NetworkInterface;

    iget-object p2, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastSocket:Ljava/net/MulticastSocket;

    iget-object p3, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastGroup:Ljava/net/SocketAddress;

    invoke-virtual {p2, p3, p1}, Ljava/net/MulticastSocket;->joinGroup(Ljava/net/SocketAddress;Ljava/net/NetworkInterface;)V

    iget-object p1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->datagramSocket:Ljava/net/DatagramSocket;
    ...
    iget-object p3, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->localInAddress:Ljava/net/InetAddress;
...
.method public static getSSDPSearchMessage(Ljava/lang/String;)Ljava/lang/String;
    ...
    sget v2, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->MX:I
...
.method public close()V
    ...
    iget-object v0, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastSocket:Ljava/net/MulticastSocket;

    if-eqz v0, :cond_0

    :try_start_0
    iget-object v1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastGroup:Ljava/net/SocketAddress;

    iget-object v2, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->networkInterface:Ljava/net/NetworkInterface;
    ...
    :cond_0
    iget-object v0, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->datagramSocket:Ljava/net/DatagramSocket;
...
.method public isConnected()Z
    ...
    iget-object v1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastSocket:Ljava/net/MulticastSocket;
...
.method public send(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->multicastGroup:Ljava/net/SocketAddress;
...
.method public setTimeout(I)V
    ...
    iput p1, p0, Lcodematics/tv/cast/discovery/provider/ssdp/SSDPClient;->timeout:I
