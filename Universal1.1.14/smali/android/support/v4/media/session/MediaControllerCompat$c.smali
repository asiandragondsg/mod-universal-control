...
.method constructor <init>(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/media/session/MediaSessionCompat$Token;->b()Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Landroid/os/IBinder;

    invoke-static {p1}, Landroid/support/v4/media/session/b$a;->j0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
...
.method public b()Landroid/app/PendingIntent;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->k2()Landroid/app/PendingIntent;
...
.method public d(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/media/session/b;->s1(Landroid/support/v4/media/session/a;)V
...
.method public x0()Landroid/support/v4/media/MediaMetadataCompat;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->x0()Landroid/support/v4/media/MediaMetadataCompat;
