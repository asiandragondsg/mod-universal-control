...
# instance fields
.field private g:Lk/b/b/b/f/i/q0;

.field private final synthetic h:Lcom/google/android/gms/measurement/internal/oa;


# direct methods
.method constructor <init>(Lcom/google/android/gms/measurement/internal/oa;Ljava/lang/String;ILk/b/b/b/f/i/q0;)V
    .locals 0
    ...
    iput-object p4, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;
...
.method final a()I
    ...
    iget-object v0, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;

    invoke-virtual {v0}, Lk/b/b/b/f/i/q0;->F()I
...
.method final k(Ljava/lang/Long;Ljava/lang/Long;Lk/b/b/b/f/i/k1;Z)Z
    .locals 10
    ...
    invoke-virtual {v0, v3, v4}, Lcom/google/android/gms/measurement/internal/c;->A(Ljava/lang/String;Lcom/google/android/gms/measurement/internal/o3;)Z
    ...
    :goto_0
    iget-object v3, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;

    invoke-virtual {v3}, Lk/b/b/b/f/i/q0;->I()Z

    move-result v3

    iget-object v4, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;

    invoke-virtual {v4}, Lk/b/b/b/f/i/q0;->J()Z

    move-result v4

    iget-object v5, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;

    invoke-virtual {v5}, Lk/b/b/b/f/i/q0;->M()Z
    ...
    iget-object p3, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;
    ...
    :cond_4
    iget-object v6, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;

    invoke-virtual {v6}, Lk/b/b/b/f/i/q0;->H()Lk/b/b/b/f/i/o0;

    move-result-object v6

    invoke-virtual {v6}, Lk/b/b/b/f/i/o0;->J()Z

    move-result v7

    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->V()Z

    move-result v8

    if-eqz v8, :cond_6

    invoke-virtual {v6}, Lk/b/b/b/f/i/o0;->G()Z
    ...
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->R()Ljava/lang/String;
    ...
    :cond_5
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->W()J

    move-result-wide v8

    invoke-virtual {v6}, Lk/b/b/b/f/i/o0;->H()Lk/b/b/b/f/i/p0;

    move-result-object v4

    invoke-static {v8, v9, v4}, Lcom/google/android/gms/measurement/internal/ra;->c(JLk/b/b/b/f/i/p0;)Ljava/lang/Boolean;
    ...
    :cond_6
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->X()Z
    ...
    :cond_7
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->Y()D
    ...
    invoke-static {v8, v9, v4}, Lcom/google/android/gms/measurement/internal/ra;->b(DLk/b/b/b/f/i/p0;)Ljava/lang/Boolean;
    ...
    :cond_8
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->T()Z

    move-result v8

    if-eqz v8, :cond_c

    invoke-virtual {v6}, Lk/b/b/b/f/i/o0;->D()Z
    ...
    :cond_9
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->U()Ljava/lang/String;

    move-result-object v8

    invoke-static {v8}, Lcom/google/android/gms/measurement/internal/z9;->T(Ljava/lang/String;)Z
    ...
    invoke-static {v4, v6}, Lcom/google/android/gms/measurement/internal/ra;->e(Ljava/lang/String;Lk/b/b/b/f/i/p0;)Ljava/lang/Boolean;
    ...
    invoke-virtual {v6}, Lk/b/b/b/f/i/o0;->F()Lk/b/b/b/f/i/r0;
    ...
    invoke-static {v4, v6, v8}, Lcom/google/android/gms/measurement/internal/ra;->g(Ljava/lang/String;Lk/b/b/b/f/i/r0;Lcom/google/android/gms/measurement/internal/v3;)Ljava/lang/Boolean;
    ...
    iget-object p4, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;

    invoke-virtual {p4}, Lk/b/b/b/f/i/q0;->I()Z
    ...
    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->J()Z

    move-result p4

    if-eqz p4, :cond_15

    invoke-virtual {p3}, Lk/b/b/b/f/i/k1;->L()J
    ...
    iget-object p1, p0, Lcom/google/android/gms/measurement/internal/ua;->g:Lk/b/b/b/f/i/q0;
