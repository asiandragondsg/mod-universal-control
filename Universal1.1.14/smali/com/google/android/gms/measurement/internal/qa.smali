...
.field private c:Lk/b/b/b/f/i/i1;
...
.method private constructor <init>(Lcom/google/android/gms/measurement/internal/oa;Ljava/lang/String;Lk/b/b/b/f/i/i1;Ljava/util/BitSet;Ljava/util/BitSet;Ljava/util/Map;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p3, p0, Lcom/google/android/gms/measurement/internal/qa;->c:Lk/b/b/b/f/i/i1;

    return-void
.end method

.method synthetic constructor <init>(Lcom/google/android/gms/measurement/internal/oa;Ljava/lang/String;Lk/b/b/b/f/i/i1;Ljava/util/BitSet;Ljava/util/BitSet;Ljava/util/Map;Ljava/util/Map;Lcom/google/android/gms/measurement/internal/na;)V
    .locals 0

    invoke-direct/range {p0 .. p7}, Lcom/google/android/gms/measurement/internal/qa;-><init>(Lcom/google/android/gms/measurement/internal/oa;Ljava/lang/String;Lk/b/b/b/f/i/i1;Ljava/util/BitSet;Ljava/util/BitSet;Ljava/util/Map;Ljava/util/Map;)V
...
# virtual methods
.method final a(I)Lk/b/b/b/f/i/a1;
    .locals 7

    invoke-static {}, Lk/b/b/b/f/i/a1;->S()Lk/b/b/b/f/i/a1$a;

    move-result-object v0

    invoke-virtual {v0, p1}, Lk/b/b/b/f/i/a1$a;->v(I)Lk/b/b/b/f/i/a1$a;

    iget-boolean p1, p0, Lcom/google/android/gms/measurement/internal/qa;->b:Z

    invoke-virtual {v0, p1}, Lk/b/b/b/f/i/a1$a;->y(Z)Lk/b/b/b/f/i/a1$a;

    iget-object p1, p0, Lcom/google/android/gms/measurement/internal/qa;->c:Lk/b/b/b/f/i/i1;

    if-eqz p1, :cond_0

    invoke-virtual {v0, p1}, Lk/b/b/b/f/i/a1$a;->x(Lk/b/b/b/f/i/i1;)Lk/b/b/b/f/i/a1$a;
    ...
    invoke-static {v1}, Lcom/google/android/gms/measurement/internal/z9;->F(Ljava/util/BitSet;)Ljava/util/List;

    move-result-object v1

    invoke-virtual {p1, v1}, Lk/b/b/b/f/i/i1$a;->A(Ljava/lang/Iterable;)Lk/b/b/b/f/i/i1$a;
    ...
    invoke-virtual {p1, v1}, Lk/b/b/b/f/i/i1$a;->x(Ljava/lang/Iterable;)Lk/b/b/b/f/i/i1$a;
    ...
    invoke-static {}, Lk/b/b/b/f/i/b1;->L()Lk/b/b/b/f/i/b1$a;

    move-result-object v4

    invoke-virtual {v4, v3}, Lk/b/b/b/f/i/b1$a;->v(I)Lk/b/b/b/f/i/b1$a;
    ...
    invoke-virtual {v4, v5, v6}, Lk/b/b/b/f/i/b1$a;->w(J)Lk/b/b/b/f/i/b1$a;
    ...
    :cond_2
    :goto_1
    invoke-virtual {p1, v1}, Lk/b/b/b/f/i/i1$a;->B(Ljava/lang/Iterable;)Lk/b/b/b/f/i/i1$a;
    ...
    invoke-static {}, Lk/b/b/b/f/i/j1;->M()Lk/b/b/b/f/i/j1$a;
    ...
    invoke-virtual {v4, v5}, Lk/b/b/b/f/i/j1$a;->v(I)Lk/b/b/b/f/i/j1$a;
    ...
    invoke-virtual {v4, v3}, Lk/b/b/b/f/i/j1$a;->w(Ljava/lang/Iterable;)Lk/b/b/b/f/i/j1$a;
    ...
    :cond_5
    :goto_3
    invoke-virtual {p1, v1}, Lk/b/b/b/f/i/i1$a;->C(Ljava/lang/Iterable;)Lk/b/b/b/f/i/i1$a;

    invoke-virtual {v0, p1}, Lk/b/b/b/f/i/a1$a;->w(Lk/b/b/b/f/i/i1$a;)Lk/b/b/b/f/i/a1$a;
...
.method final c(Lcom/google/android/gms/measurement/internal/ra;)V
    ...
    invoke-virtual {v0, v4, v5}, Lcom/google/android/gms/measurement/internal/c;->A(Ljava/lang/String;Lcom/google/android/gms/measurement/internal/o3;)Z
