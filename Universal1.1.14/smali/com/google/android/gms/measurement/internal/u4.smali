...
.method private final K(Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/measurement/internal/r9;->p()Lcom/google/android/gms/measurement/internal/g;

    move-result-object v0

    invoke-virtual {v0, p1}, Lcom/google/android/gms/measurement/internal/g;->r0(Ljava/lang/String;)[B
    ...
    :cond_0
    invoke-direct {p0, p1, v0}, Lcom/google/android/gms/measurement/internal/u4;->w(Ljava/lang/String;[B)Lk/b/b/b/f/i/w0;

    move-result-object v0

    invoke-virtual {v0}, Lk/b/b/b/f/i/g7;->x()Lk/b/b/b/f/i/g7$b;

    move-result-object v0

    check-cast v0, Lk/b/b/b/f/i/w0$a;

    invoke-direct {p0, p1, v0}, Lcom/google/android/gms/measurement/internal/u4;->y(Ljava/lang/String;Lk/b/b/b/f/i/w0$a;)V
    ...
    check-cast v3, Lk/b/b/b/f/i/w0;

    invoke-static {v3}, Lcom/google/android/gms/measurement/internal/u4;->x(Lk/b/b/b/f/i/w0;)Ljava/util/Map;
...
.method private final w(Ljava/lang/String;[B)Lk/b/b/b/f/i/w0;
    .locals 7
    ...
    invoke-static {}, Lk/b/b/b/f/i/w0;->Q()Lk/b/b/b/f/i/w0;
    ...
    :cond_0
    :try_start_0
    invoke-static {}, Lk/b/b/b/f/i/w0;->P()Lk/b/b/b/f/i/w0$a;

    move-result-object v1

    invoke-static {v1, p2}, Lcom/google/android/gms/measurement/internal/z9;->A(Lk/b/b/b/f/i/r8;[B)Lk/b/b/b/f/i/r8;

    check-cast v1, Lk/b/b/b/f/i/w0$a;
    ...
    invoke-virtual {p2}, Lk/b/b/b/f/i/w0;->G()Z
    ...
    invoke-virtual {p2}, Lk/b/b/b/f/i/w0;->H()J
    ...
    :goto_0
    invoke-virtual {p2}, Lk/b/b/b/f/i/w0;->I()Z

    move-result v5

    if-eqz v5, :cond_2

    invoke-virtual {p2}, Lk/b/b/b/f/i/w0;->J()Ljava/lang/String;
    ...
    :try_end_0
    .catch Lk/b/b/b/f/i/r7; {:try_start_0 .. :try_end_0} :catch_1
...
.method private static x(Lk/b/b/b/f/i/w0;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0}, Lk/b/b/b/f/i/w0;->L()Ljava/util/List;
    ...
    check-cast v1, Lk/b/b/b/f/i/x0;

    invoke-virtual {v1}, Lk/b/b/b/f/i/x0;->B()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1}, Lk/b/b/b/f/i/x0;->C()Ljava/lang/String;
...
.method private final y(Ljava/lang/String;Lk/b/b/b/f/i/w0$a;)V
    .locals 8
    ...
    :goto_0
    invoke-virtual {p2}, Lk/b/b/b/f/i/w0$a;->v()I

    move-result v4

    if-ge v3, v4, :cond_6

    invoke-virtual {p2, v3}, Lk/b/b/b/f/i/w0$a;->w(I)Lk/b/b/b/f/i/v0;
    ...
    check-cast v4, Lk/b/b/b/f/i/v0$a;

    invoke-virtual {v4}, Lk/b/b/b/f/i/v0$a;->w()Ljava/lang/String;
    ...
    invoke-virtual {v4, v6}, Lk/b/b/b/f/i/v0$a;->v(Ljava/lang/String;)Lk/b/b/b/f/i/v0$a;

    invoke-virtual {p2, v3, v4}, Lk/b/b/b/f/i/w0$a;->x(ILk/b/b/b/f/i/v0$a;)Lk/b/b/b/f/i/w0$a;
    ...
    invoke-virtual {v6, v7}, Lcom/google/android/gms/measurement/internal/c;->t(Lcom/google/android/gms/measurement/internal/o3;)Z
    ...
    :goto_1
    invoke-virtual {v4}, Lk/b/b/b/f/i/v0$a;->x()Z
    ...
    invoke-virtual {v4}, Lk/b/b/b/f/i/v0$a;->y()Z
    ...
    invoke-virtual {v4}, Lk/b/b/b/f/i/v0$a;->z()Z

    move-result v5

    if-eqz v5, :cond_5

    invoke-virtual {v4}, Lk/b/b/b/f/i/v0$a;->A()I
...
.method final B(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/measurement/internal/u4;->K(Ljava/lang/String;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lcom/google/android/gms/measurement/internal/u4;->J(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p2}, Lcom/google/android/gms/measurement/internal/da;->e0(Ljava/lang/String;)Z
...
.method final G(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/measurement/internal/u4;->v(Ljava/lang/String;)Lk/b/b/b/f/i/w0;
    ...
    :cond_0
    invoke-virtual {p1}, Lk/b/b/b/f/i/w0;->O()Z
...
.method final H(Ljava/lang/String;)J
    ...
    invoke-virtual {p0, p1, v0}, Lcom/google/android/gms/measurement/internal/u4;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method protected final v(Ljava/lang/String;)Lk/b/b/b/f/i/w0;
    .locals 1
...
.method protected final z(Ljava/lang/String;[BLjava/lang/String;)Z
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/measurement/internal/u4;->w(Ljava/lang/String;[B)Lk/b/b/b/f/i/w0;
    ...
    check-cast v2, Lk/b/b/b/f/i/w0;

    invoke-static {v2}, Lcom/google/android/gms/measurement/internal/u4;->x(Lk/b/b/b/f/i/w0;)Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lk/b/b/b/f/i/w0$a;->y()Ljava/util/List;

    move-result-object v3

    invoke-direct {v2, v3}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    invoke-virtual {p3, p1, v2}, Lcom/google/android/gms/measurement/internal/g;->Q(Ljava/lang/String;Ljava/util/List;)V

    :try_start_0
    invoke-virtual {v0}, Lk/b/b/b/f/i/w0$a;->z()Lk/b/b/b/f/i/w0$a;

    invoke-virtual {v0}, Lk/b/b/b/f/i/g7$b;->h()Lk/b/b/b/f/i/s8;

    move-result-object p3

    check-cast p3, Lk/b/b/b/f/i/g7;

    check-cast p3, Lk/b/b/b/f/i/w0;
