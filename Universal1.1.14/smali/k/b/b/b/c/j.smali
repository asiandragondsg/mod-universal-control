...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lk/b/b/b/c/j;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lk/b/b/b/c/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lk/b/b/b/c/j;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static c(I)Ljava/lang/String;
    ...
    invoke-static {p0}, Lk/b/b/b/c/b;->H(I)Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)Z
    ...
    sget-boolean v0, Lk/b/b/b/c/j;->c:Z
    ...
    invoke-virtual {v0, v3, v4}, Lk/b/b/b/c/r/b;->e(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v0

    invoke-static {p0}, Lk/b/b/b/c/k;->a(Landroid/content/Context;)Lk/b/b/b/c/k;

    if-eqz v0, :cond_0

    invoke-static {v0, v1}, Lk/b/b/b/c/k;->f(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-nez p0, :cond_0

    invoke-static {v0, v2}, Lk/b/b/b/c/k;->f(Landroid/content/pm/PackageInfo;Z)Z

    move-result p0

    if-eqz p0, :cond_0

    sput-boolean v2, Lk/b/b/b/c/j;->b:Z

    goto :goto_0

    :cond_0
    sput-boolean v1, Lk/b/b/b/c/j;->b:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :goto_0
    sput-boolean v2, Lk/b/b/b/c/j;->c:Z
    ...
    :cond_1
    :goto_2
    sget-boolean p0, Lk/b/b/b/c/j;->b:Z
...
.method public static g(Landroid/content/Context;I)I
    ...
    sget-object v0, Lk/b/b/b/c/j;->e:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/internal/t0;->b(Landroid/content/Context;)I

    move-result v0

    if-eqz v0, :cond_1

    sget v1, Lk/b/b/b/c/j;->a:I
    ...
    :goto_2
    invoke-static {p0, v0, p1}, Lk/b/b/b/c/j;->l(Landroid/content/Context;ZI)I
...
.method public static h(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lk/b/b/b/c/j;->m(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static l(Landroid/content/Context;ZI)I
    .locals 9
    ...
    invoke-static {v8, v1}, Lk/b/b/b/c/k;->f(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0, v1}, Lk/b/b/b/c/k;->f(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Lcom/google/android/gms/common/util/y;->a(I)I

    move-result p0

    invoke-static {p2}, Lcom/google/android/gms/common/util/y;->a(I)I
...
.method static m(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lk/b/b/b/c/j;->i(Landroid/content/Context;)Z
