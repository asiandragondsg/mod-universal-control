...
.method public constructor <init>(Ljava/util/concurrent/Executor;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/crashlytics/d/h/i;->b:Lk/b/b/b/i/i;
...
.method private d(Lk/b/b/b/i/i;)Lk/b/b/b/i/i;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method private f(Ljava/util/concurrent/Callable;)Lk/b/b/b/i/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method g(Ljava/lang/Runnable;)Lk/b/b/b/i/i;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p0, v0}, Lcom/google/firebase/crashlytics/d/h/i;->h(Ljava/util/concurrent/Callable;)Lk/b/b/b/i/i;
...
.method public h(Ljava/util/concurrent/Callable;)Lk/b/b/b/i/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/firebase/crashlytics/d/h/i;->b:Lk/b/b/b/i/i;

    iget-object v2, p0, Lcom/google/firebase/crashlytics/d/h/i;->a:Ljava/util/concurrent/Executor;

    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/d/h/i;->f(Ljava/util/concurrent/Callable;)Lk/b/b/b/i/a;

    move-result-object p1

    invoke-virtual {v1, v2, p1}, Lk/b/b/b/i/i;->j(Ljava/util/concurrent/Executor;Lk/b/b/b/i/a;)Lk/b/b/b/i/i;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/google/firebase/crashlytics/d/h/i;->d(Lk/b/b/b/i/i;)Lk/b/b/b/i/i;

    move-result-object v1

    iput-object v1, p0, Lcom/google/firebase/crashlytics/d/h/i;->b:Lk/b/b/b/i/i;
...
.method public i(Ljava/util/concurrent/Callable;)Lk/b/b/b/i/i;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-virtual {v1, v2, p1}, Lk/b/b/b/i/i;->k(Ljava/util/concurrent/Executor;Lk/b/b/b/i/a;)Lk/b/b/b/i/i;
