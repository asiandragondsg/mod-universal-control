...
# instance fields
.field private final I0:Landroidx/appcompat/widget/j0;

.field private final J0:Landroid/view/accessibility/AccessibilityManager;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/textfield/g;->K0:Landroid/graphics/Rect;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getContext()Landroid/content/Context;

    move-result-object p1

    sget-object v3, Lk/b/b/c/l;->H0:[I

    sget v5, Lk/b/b/c/k;->d:I
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/g;->J0:Landroid/view/accessibility/AccessibilityManager;
    ...
    iput-object p3, p0, Lcom/google/android/material/textfield/g;->I0:Landroidx/appcompat/widget/j0;

    const/4 p1, 0x1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/j0;->I(Z)V

    invoke-virtual {p3, p0}, Landroidx/appcompat/widget/j0;->C(Landroid/view/View;)V

    const/4 p1, 0x2

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/j0;->H(I)V

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object p1

    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/j0;->o(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {p3, p1}, Landroidx/appcompat/widget/j0;->K(Landroid/widget/AdapterView$OnItemClickListener;)V
...
.method static synthetic a(Lcom/google/android/material/textfield/g;)Landroidx/appcompat/widget/j0;
    ...
    iget-object p0, p0, Lcom/google/android/material/textfield/g;->I0:Landroidx/appcompat/widget/j0;
...
.method private d()I
    ...
    iget-object v5, p0, Lcom/google/android/material/textfield/g;->I0:Landroidx/appcompat/widget/j0;

    invoke-virtual {v5}, Landroidx/appcompat/widget/j0;->w()I
    ...
    :cond_3
    iget-object v0, p0, Lcom/google/android/material/textfield/g;->I0:Landroidx/appcompat/widget/j0;

    invoke-virtual {v0}, Landroidx/appcompat/widget/j0;->h()Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-eqz v0, :cond_4

    iget-object v2, p0, Lcom/google/android/material/textfield/g;->K0:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lcom/google/android/material/textfield/g;->K0:Landroid/graphics/Rect;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, Lcom/google/android/material/textfield/g;->I0:Landroidx/appcompat/widget/j0;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, Landroidx/appcompat/widget/j0;->o(Landroid/widget/ListAdapter;)V
...
.method public showDropDown()V
    ...
    iget-object v0, p0, Lcom/google/android/material/textfield/g;->J0:Landroid/view/accessibility/AccessibilityManager;
