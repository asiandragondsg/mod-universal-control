...
.field private final d1:Landroid/widget/CheckedTextView;

.field private e1:Landroid/widget/FrameLayout;

.field private f1:Landroidx/appcompat/view/menu/i;

.field private g1:Landroid/content/res/ColorStateList;

.field private h1:Z

.field private i1:Landroid/graphics/drawable/Drawable;

.field private final j1:Li/h/o/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/material/internal/NavigationMenuItemView;->k1:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p2, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->j1:Li/h/o/a;
    ...
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->d1:Landroid/widget/CheckedTextView;

    invoke-virtual {p1, v1}, Landroid/widget/CheckedTextView;->setDuplicateParentStateEnabled(Z)V

    invoke-static {p1, p2}, Li/h/o/t;->h0(Landroid/view/View;Li/h/o/a;)V
...
.method private B()V
    ...
    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->d1:Landroid/widget/CheckedTextView;

    const/16 v1, 0x8

    invoke-virtual {v0, v1}, Landroid/widget/CheckedTextView;->setVisibility(I)V

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->e1:Landroid/widget/FrameLayout;
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->e1:Landroid/widget/FrameLayout;
...
.method private C()Landroid/graphics/drawable/StateListDrawable;
    ...
    sget-object v2, Lcom/google/android/material/internal/NavigationMenuItemView;->k1:[I
...
.method private D()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->f1:Landroidx/appcompat/view/menu/i;
...
.method private setActionView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->e1:Landroid/widget/FrameLayout;
...
.method public e(Landroidx/appcompat/view/menu/i;I)V
    ...
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->f1:Landroidx/appcompat/view/menu/i;
    ...
    invoke-static {p0, p2}, Li/h/o/t;->k0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object v0, Lcom/google/android/material/internal/NavigationMenuItemView;->k1:[I
...
.method public setCheckable(Z)V
    ...
    iget-boolean v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->c1:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->c1:Z

    iget-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->j1:Li/h/o/a;

    iget-object v0, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->d1:Landroid/widget/CheckedTextView;

    const/16 v1, 0x800

    invoke-virtual {p1, v0, v1}, Li/h/o/a;->l(Landroid/view/View;I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-boolean v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->h1:Z
    ...
    iget-object v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->g1:Landroid/content/res/ColorStateList;
    ...
    :cond_1
    iget v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->a1:I
    ...
    :cond_2
    iget-boolean v1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->b1:Z

    if-eqz v1, :cond_4

    iget-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->i1:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1, v1, v2}, Li/h/e/c/f;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->i1:Landroid/graphics/drawable/Drawable;
...
.method public setIconSize(I)V
    ...
    iput p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->a1:I
...
.method setIconTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->g1:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-boolean p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->h1:Z

    iget-object p1, p0, Lcom/google/android/material/internal/NavigationMenuItemView;->f1:Landroidx/appcompat/view/menu/i;
